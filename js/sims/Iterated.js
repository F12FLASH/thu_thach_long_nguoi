...
function Iterated(config) {
    ...
    // Payoffs
    self.payoffs = _makeMovieClip("iterated_payoffs", {
        scale: 0.5
    });
...
function IteratedPeep(config) {
    ...
    // Coin
    self.coin = _makeMovieClip("iterated_coin", {
        scale: 0.5
    });
    ...
    self.payoffCoins = [];
    for (var i = 0; i < 3; i++) {
        var c = _makeMovieClip("iterated_coin", {
            scale: 0.5
        });
        c.visible = false;
            ...
            for (var i = 0; i < 3; i++) {
                ...
                (function(c, i, payoff) {
                    ...
                    Tween_get(c)
                        ...
                        .to({
                            y: -120
                        }, _s(0.15), Ease.circOut) // y
                        .to({
                            y: -20
                        }, _s(0.15), Ease.circIn); // y
                })(c, i, self.payoff);
            }
